---
source: Works Overview - OpenAlex Developers
...
# Works Overview - OpenAlex Developers
...
The API supports filtering, sorting, and grouping on works fields. See Filtering, Sorting, and Grouping for syntax.
Fields marked **(deprecated)** are `.search` filters — use the `search` parameter instead.
