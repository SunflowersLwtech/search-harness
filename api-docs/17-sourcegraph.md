---
source: Sourcegraph streaming search API - Sourcegraph docs
url: https://sourcegraph.com/docs/api/stream_api/
final_url: https://sourcegraph.com/docs/api/stream-api
language: en
fetched_at: 2026-05-04
bytes: 8463
---

# Sourcegraph streaming search API - Sourcegraph docs
...
> events format. However, we do not guarantee compatibility
